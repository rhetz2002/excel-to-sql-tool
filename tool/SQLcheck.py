    ...
    while (db_open is False):
        ...
        try:
            ...
            try: 
                ...
                if input ("there is a database here but the schema required dose not exist, do you want to add it? [Y/N] ").lower() == 'y':
                
                    log = log + f'{time.strftime("%I:%M:%S %p")}: required db ' \
                                f'schema not found in {filepath}, asking user for permission to create schema\n'

                    db = database.cursor()
                
                    # creates table in db
                    
                    log += 'attempting to create new table in existing db file'
                    ...
                    if 'employee_name' not in column_name:
                        ...
                        try:
                            ...
                            log += 'appending to existing schema: failed to create employee_name'
                    ...
                    if 'employee_email' not in column_name:
                        ...
                        try:
                            ...
                            log += 'appending to existing schema: failed to create employee_email'
                    ...
                    if 'department' not in column_name:
                        ...
                        try:
                            ...
                            log += 'appending to existing schema: failed to create department'
                    ...
                    if 'sales' not in column_name:
                        ...
                        try:
                            ...
                            log += 'appending to existing schema: failed to create sales'
            ...
            if not db_open:
                ...
                filepath = input('input path to database file, include file name and extension: ')
